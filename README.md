...
Using the convenient UI provided by Bugfender requires only to request a new View Controller to Bugfender and present it modally. All you need is to call the following method and complete the required params with the title and placeholders for your UI.
                                 ...
                                 cancelButtonTitle:@"Cancel"
                                        completion:^(BOOL feedbackSent) {
                                            if (feedbackSent) {
                                                ...
                                                // User decided not sending feedback
                                            }
                                        }];
...
Additionally, if you require more customization you can configure the view controller prior to present it. 

*Notice that Bugfender returns BFUserFeedbackNavigationController which is a subclass of navigation controller. You need to access the view controller using the public property feedbackViewController.*
...
If you need further customization than provided by BFUserFeedbackViewController you can implement your own UI. All you have to do is collect your user feedback in the convenient textfields and send it to Bugfender using the provided method for it. 
