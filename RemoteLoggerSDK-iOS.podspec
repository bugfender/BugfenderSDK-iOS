#
#  Be sure to run `pod spec lint RemoteLoggerSDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/mobilejazz/RemoteLoggerSDK-iOS"
  ...
  # Or just: s.author    = "Joan Martin"
  # s.authors            = { "Joan Martin" => "vilanovi@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/mobilejazz/RemoteLoggerSDK-iOS.git", :tag => "0.1.0" }
  ...
  s.public_header_files = "include/RemoteLoggerSDK/*.h"
